...
public class CreateNewProductJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        avail.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        avail.setText("Product Avaliability:");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(avail, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(10, 10, 10)
                .addComponent(btnAdd)
                .addContainerGap())
        );
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Please check the price and quantity format", "Info", JOptionPane.INFORMATION_MESSAGE);
            e.printStackTrace();
            return;
        }
