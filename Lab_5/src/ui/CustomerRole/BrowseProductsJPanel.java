...
public class BrowseProductsJPanel extends javax.swing.JPanel {
 ...
 Order currentOrder;
    ...
    private void btnModifyQuantityActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModifyQuantityActionPerformed
        ...
        OrderItems item  = (OrderItems) tblCart.getValueAt(selectedRowIndex, 0);
    ...
    private void btnAddToCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddToCartActionPerformed
        ...
        OrderItems item= currentOrder.findProduct(product);
        if(item==null){
        ...
        ArrayList<OrderItems> a = currentOrder.getOrderItemsList();
        OrderItems ab = a.get(0);
        System.out.println(ab.getQuantity());
                System.out.println(ab.getProduct());

                        System.out.println(ab.getSalesPrice());
    ...
    private void populateCartTable() {
        ...
        for (OrderItems oi : currentOrder.getOrderItemsList()) {
            Object row[] = new Object[4];
            row[0] = oi;
     ...
     private void populateProductTable(String pro) {
        ...
        for (Supplier s : supplierDirectory.getSupplierlist()) {
            ...
            for (Product p : s.getProductCatalog().getProductcatalog()) {
                if (p.getProdName().equalsIgnoreCase(pro)) {
